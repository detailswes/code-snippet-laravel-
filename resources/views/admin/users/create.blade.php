    ...
    <x-slot name="body">
        <form id="create-form">
            <div class="form-group form-row-parent row">
                <label class="col-lg-12 col-xl-12 col-form-label" for="first_name">First Name
                    <em>*</em>
                </label>
            ...
            <div class="form-group form-row-parent row">
                <label class="col-lg-12 col-xl-12 col-form-label" for="last_name">Last Name
                    <em>*</em>
                </label>
                <div class="col-lg-12 col-xl-12">
            ...
            <div class="form-group form-row-parent row">
                <label class="col-lg-12 col-xl-12 col-form-label" for="email">Email <em>*</em></label>
                <div class="col-lg-12 col-xl-12">
            ...
            @if (!$user)
                <div class="form-group form-row-parent row">
                    <label class="col-lg-12 col-xl-12 col-form-label" for="password">Password <em>*</em> </label>
                    <div class="col-lg-12 col-xl-12">
            ...
            @endif
            <div class="form-group form-row-parent row">
                <label class="col-lg-12 col-xl-12 col-form-label" for="role_id">Role <em>*</em> </label>
                <div class="col-lg-12 col-xl-12">
